...
type Props = StackScreenProps<MainNavigationParams, 'ForgotPIN'>;

const ForgotPINScreen = ({ route } : Props) => {
    ...
    const submitHandler = async () => {
        ...
        try {
            ...
            const result = await resetPIN(payload);
            ...
            Toast.show({
                ...
                title: 'Error',
                textBody: err.message || 'Error registering PIN',
                autoClose: 2000,
            });
        }
    }
                    ...
                    >
                        <View className='flex-1 justify-between'>
                            <View>
                                ...
                                <View className='py-1' />
                                <Text className='text-gray-700 self-center'>Enter new 6-digit PIN to reset.</Text>
                                <View className='py-6' />
                                <View className='h-[50]'>
                                    <OtpInput
