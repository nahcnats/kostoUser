...
import { GetWalletTransactionsParams, getWalletTransactions } from '../../../services/walletServices';
import {
    Empty,
    Seperator,
    Error500,
...
const VouchersScreen = () => {
    ...
    const {
        ...
        queryFn: ({ pageParam }) => getWalletTransactions(pageParam, payload),
        initialPageParam: 1,
    ...
    const VoucherItem = ({ itemData } : HistoryItemProps) => {
        return (
            <TouchableOpacity
                onPress={() => {
                ...
                <View className='flex-row justify-between items-center gap-4'>
                    ...
                    <View className='flex-1'>
                        <View className='flex-1 flex-wrap'>
                            <Text className='text-black text-sm font-bold' numberOfLines={1} ellipsizeMode='tail'>Purchased Voucher</Text>
                        </View>
    ...
    if (isError) {
        Toast.show({
            ...
            title: 'Error',
            textBody: walletTransactionsError.message,
            autoClose: 2000,
        });
    ...
    return (
        <View className='flex-1 pb-16'>
            <FlatList 
                ...
                renderItem={({ item }) => <VoucherItem itemData={item} />}
                ...
                ListEmptyComponent={<Empty message='No purchased vouchers found!' />}
                ...
                <View className='flex-1 justify-between pb-8'>
                    <View className='items-center pt-4'>
                        ...
                        <View className='items-center gap-1 mt-4'>
                            <Text className='text-green-800 text-2xl font-bold'>Purchase Detail</Text>
                            <Text className='text-black text-xs'>Top Up Voucher</Text>
